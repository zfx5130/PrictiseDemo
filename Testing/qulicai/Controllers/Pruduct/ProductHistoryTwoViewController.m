...
- (void)requestProduct {
    ...
    [request startWithCompletionBlockWithSuccess:^(__kindof YTKBaseRequest * _Nonnull request) {
        ...
        } else if (historyList.statusType == IndentityStatusTypeInvalid) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView
    ...
    cell.timeLabel.text = [[[NSString stringWithTimeInterval:([history.addTime doubleValue] + 1 * 24 * 60 * 60 * 1000) / 1000] componentsSeparatedByString:@" "] firstObject];
